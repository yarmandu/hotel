  ...
  window.Site = $.site.extend({
    run: function(next) {
      ...
      if (typeof Waves !== 'undefined') {
        ...
        Waves.attach('.page-content .btn:not(.ladda-button):not(.btn-round):not(.btn-pure):not(.btn-floating):not(.btn-flat)', ['waves-light']);
        Waves.attach('.page-content .btn-pure:not(.ladda-button):not(.btn-round):not(.btn-floating):not(.btn-flat):not(.icon)', ['waves-classic']);
      }
